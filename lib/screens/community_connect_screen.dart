...
class CommunityConnectScreen extends ConsumerStatefulWidget {
  const CommunityConnectScreen({super.key});

  @override
  ConsumerState<CommunityConnectScreen> createState() =>
      _CommunityConnectScreenState();
}

class _CommunityConnectScreenState
    extends ConsumerState<CommunityConnectScreen> {
                ...
                children: [
                  ...
                  const Text(
                    ...
                    style: TextStyle(
                      ...
                      color: Color.fromRGBO(26, 61, 124, 1), // Navy Blue
                    ),
                  ),
                ],
              ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // 3. Connect Button (Pill Shape)
          SizedBox(
            height: 32,
            child: ElevatedButton(
              onPressed: () {
                // Update selected mentor and navigate to profile
